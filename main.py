...
# =========================
# UPDATED LINKS (REQUESTED)
# =========================
REG_LINK = "https://tkclub2.com/#/register?invitationCode=18753202056"
OWNER_LINK = "https://t.me/OWNER_MARUF_TOP"

# =========================
# NEW TKCLUB2 API (REQUESTED)
# =========================
TKCLUB2_API = "https://api880.inpay88.net/api/webapi/GetNoaverageEmerdList"
...
# =========================
# FETCH (UPDATED TO TKCLUB2)
# =========================
def _fetch_latest_issue_sync(mode: str) -> Optional[dict]:
    payload = {
        "pageSize": 1,
        "pageNo": 1,
        "typeId": 5 if mode == "30S" else 1,  # REQUESTED LOGIC
    }
...
def _footer_bengali() -> str:
    return (
        ...
        f"📝 REG: <a href='{REG_LINK}'>Link Here</a>\n"
        f"👤 OWNER: <a href='{OWNER_LINK}'>Link Here</a>"
    )
